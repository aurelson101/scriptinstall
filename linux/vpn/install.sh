...
# https://github.com/aurelson101/scriptinstall/tree/main/linux/vpn
...
function installQuestions() {
	...
	echo "The git repository is available at: https://github.com/aurelson101/scriptinstall/tree/main/linux/vpn"
	echo ""
